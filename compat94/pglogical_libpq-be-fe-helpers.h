...
#else
#define WaitLatchOrSocket(latch, wakeEvents, sock, timeout, wait_event_info) \
	WaitLatchOrSocket(latch, wakeEvents, sock, timeout, wait_event_info)
#endif

#if PG_VERSION_NUM < 130000
#define AcquireExternalFD() (true)
#define ReleaseExternalFD() do {} while (0)
#endif
...
#undef WaitLatchOrSocket
#undef AcquireExternalFD
#undef ReleaseExternalFD
#undef MyLatch

#endif							/* LIBPQ_BE_FE_HELPERS_H */

/*
 * Preceding half of file is v16+ header content, and following half is v17+
 * header content.  By using separate include guards, v16 can include both
 * this header and PostgreSQL's libpq/libpq-be-fe-helpers.h.
 */

#ifndef PGLOGICAL_LIBPQ_BE_FE_HELPERS_H
#define PGLOGICAL_LIBPQ_BE_FE_HELPERS_H
...
#endif							/* PGLOGICAL_LIBPQ_BE_FE_HELPERS_H */
